...
import time
import numpy as np
from codec.evaluation import calculate_sad
...
if __name__ == '__main__':
    ...
    print("Type 2 and Type 0 comparison", calculate_sad(recon_array_0, recon_array_2))
    print("Type 3 and Type 0 comparison", calculate_sad(recon_array_0, recon_array_3))