...
if __name__ == '__main__':
    ...
    print("Type 2 and Type 0 comparison", np.sum(abs(np.array(recon_array_2)-np.array(recon_array_0))))
    # print("Type 3 and Type 0 comparison", np.sum(abs(np.array(recon_array_3)-np.array(recon_array_0))))
