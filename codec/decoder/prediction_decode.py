...
class prediction_decoder:

    def __init__(self):
        self.frames=[]

    def decode_residual_ME(self, prediction, residual, vector_array, w, h, block_size):
        ...
        for i in range(n_h):
            for j in range(n_w):
                ...
                self.frames.append(block_prediction)
    ...
    def intra_decode(self, residual, mode_array, w, h, block_size):
        n_w = (w - 1) // block_size + 1
        n_h = (h - 1) // block_size + 1
